...
export default function Login() {
  ...
  return (
    <div className="max-w-sm mx-auto px-4 py-16">
      <h1 className="font-display text-3xl tracking-tightest mb-1">LOG IN</h1>
      <p className="text-sm text-ink/50 mb-6">Welcome back to ShopSphere.</p>
  ...
  "Log In"
      ...
      <p className="text-sm text-ink/60 mt-4">
        New here? <Link to="/register" className="text-denim font-semibold hover:underline">Create an account</Link>
      </p>
    </div>
  );
}
